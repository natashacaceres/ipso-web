...
const EN_PAIRS = [
  ...
  ['Oscuro', 'Dark'], ['Claro', 'Light'], ['Solución suelta', 'Standalone solution'],
  ...
  ['Envío gratuito dentro de España y garantía de reembolso de tu dinero en hasta 30 días.', 'Free shipping within Spain and money-back guarantee within 30 days.'],
  ...
  ['Desde 4 unidades, −10%. Desde 8, −20%. Se aplica solo.', 'From 4 units, −10%. From 8, −20%. Applied automatically.'], ['Qué incluye', 'What is included'], ['Especificaciones', 'Specifications'],
  ...
  ['WiFi', 'Wi-Fi'], ['Se conectan al WiFi sin pedirte la clave.', 'They join your Wi-Fi without asking for the password.'],
  ...
  ['Menú', 'Menu'], ['Menú, reseña y redes desde la mesa.', 'Menu, review and social links from the table.'],
...
const CA_PAIRS = [
  ...
  ['Oscuro', 'Fosc'], ['Claro', 'Clar'], ['Solución suelta', 'Solució solta'],
  ...
  ['Envío gratuito dentro de España y garantía de reembolso de tu dinero en hasta 30 días.', 'Enviament gratuït dins d\u2019Espanya i garantia de devolució dels teus diners fins a 30 dies.'],
  ...
  ['Desde 4 unidades, −10%. Desde 8, −20%. Se aplica solo.', 'A partir de 4 unitats, −10%. A partir de 8, −20%. S\u2019aplica sol.'], ['Qué incluye', 'Què inclou'], ['Especificaciones', 'Especificacions'],
  ...
  ['Se conectan al WiFi sin pedirte la clave.', 'Es connecten al WiFi sense demanar-te la clau.'],
  ...
  ['Menú, reseña y redes desde la mesa.', 'Menú, ressenya i xarxes des de la taula.'],
