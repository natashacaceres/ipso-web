...
const EN_PAIRS = [
  ...
  ['pago único', 'one-off'], ['Programación incluida · Garantía 30 días', 'Programming included · 30-day guarantee'],
  ...
  ['Tu pedido', 'Your order'], ['Pago único · Programación incluida · Garantía 30 días', 'One-off payment · Programming included · 30-day guarantee'],
  ...
  ['Menú', 'Menu'], ['Tu carta desde la mesa, con IA que recomienda qué pedir.', 'Your menu from the table, with AI that recommends what to order.'],
  ['Recomendador con IA para el cliente que no se decide', 'AI recommender for customers who cannot decide'],
  ['¿Cómo recomienda la IA?', 'How does the AI recommend?'],
  ['Sugiere platos según lo que le apetece al cliente y según lo que puede comer: alérgenos, dieta vegana o vegetariana, embarazo y más. Aprende de tu carta, tú no configuras nada.', 'It suggests dishes based on what the customer feels like and what they can eat: allergens, vegan or vegetarian diet, pregnancy and more. It learns from your menu; you configure nothing.'],
  ['Se adapta a cada cliente: alérgenos, vegano, vegetariano, embarazo y más', 'Adapts to each customer: allergens, vegan, vegetarian, pregnancy and more'],
  ['Stand blanco', 'White stand'], ['Stand negro', 'Black stand'], ['Plate', 'Plate'],
  ['Programamos tu red', 'We programme your network'], ['Con tu nombre de red y tu clave, cifrada en el punto NFC.', 'With your network name and password, encrypted in the NFC point.'],
  ...
  ['Tocan y navegan', 'They tap and browse'], ['Conectados en un segundo, sin escribir nada.', 'Connected in a second, without typing anything.'],
  ['Punto NFC de WiFi programado', 'Wi-Fi contact point, programmed'], ['Programación personalizada', 'Custom programming'],
  ['Cambio de clave cuando quieras', 'Password changes whenever you want'], ['Código de respaldo para escanear', 'Backup code to scan'], ['Garantía 30 días', '30-day guarantee'],
  ...
  ['Tocan y reservan', 'They tap and book'], ['Reciben confirmación y recordatorio automático.', 'They get a confirmation and an automatic reminder.'],
  ['Sticker de puerta programado', 'Door sticker, programmed'], ['Conexión con tu agenda', 'Connection to your calendar'], ['Recordatorio automático al cliente', 'Automatic reminder for the customer'],
  ...
  ['Tocan y ven la carta', 'They tap and see the menu'], ['Se abre en su móvil, con fotos y alérgenos.', 'It opens on their phone, with photos and allergens.'],
...
const CA_PAIRS = [
  ...
  ['pago único', 'pagament únic'], ['Programación incluida · Garantía 30 días', 'Programació inclosa · Garantia 30 dies'],
  ...
  ['Tu pedido', 'La teva comanda'], ['Pago único · Programación incluida · Garantía 30 días', 'Pagament únic · Programació inclosa · Garantia 30 dies'],
  ...
  ['Menú', 'Menú'], ['Tu carta desde la mesa, con IA que recomienda qué pedir.', 'La teva carta des de la taula, amb IA que recomana què demanar.'],
  ['Recomendador con IA para el cliente que no se decide', 'Recomanador amb IA per al client que no es decideix'],
  ['¿Cómo recomienda la IA?', 'Com recomana la IA?'],
  ['Sugiere platos según lo que le apetece al cliente y según lo que puede comer: alérgenos, dieta vegana o vegetariana, embarazo y más. Aprende de tu carta, tú no configuras nada.', 'Suggereix plats segons el que li ve de gust al client i segons el que pot menjar: al·lèrgens, dieta vegana o vegetariana, embaràs i més. Aprèn de la teva carta, tu no configures res.'],
  ['Se adapta a cada cliente: alérgenos, vegano, vegetariano, embarazo y más', 'S\u2019adapta a cada client: al·lèrgens, vegà, vegetarià, embaràs i més'],
  ['Stand blanco', 'Stand blanc'], ['Stand negro', 'Stand negre'], ['Plate', 'Plate'],
  ['Programamos tu red', 'Programem la teva xarxa'], ['Con tu nombre de red y tu clave, cifrada en el punto NFC.', 'Amb el nom de la teva xarxa i la clau, xifrada al punt NFC.'],
  ...
  ['Tocan y navegan', 'Toquen i naveguen'], ['Conectados en un segundo, sin escribir nada.', 'Connectats en un segon, sense escriure res.'],
  ['Punto NFC de WiFi programado', 'Punt NFC de WiFi programat'], ['Programación personalizada', 'Programació personalitzada'],
  ['Cambio de clave cuando quieras', 'Canvi de clau quan vulguis'], ['Código de respaldo para escanear', 'Codi de reserva per escanejar'], ['Garantía 30 días', 'Garantia 30 dies'],
  ...
  ['Tocan y reservan', 'Toquen i reserven'], ['Reciben confirmación y recordatorio automático.', 'Reben confirmació i recordatori automàtic.'],
  ['Sticker de puerta programado', 'Adhesiu de porta programat'], ['Conexión con tu agenda', 'Connexió amb la teva agenda'], ['Recordatorio automático al cliente', 'Recordatori automàtic al client'],
  ...
  ['Tocan y ven la carta', 'Toquen i veuen la carta'], ['Se abre en su móvil, con fotos y alérgenos.', 'S\u2019obre al seu mòbil, amb fotos i al·lèrgens.'],
